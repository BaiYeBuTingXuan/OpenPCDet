...
class WeatherShiftDataset(DatasetTemplate):
    def __init__(self, dataset_cfg, class_names, training=True, root_path=None, logger=None, mode=None, weather):
        """
        Args:
            root_path:
            dataset_cfg:
    ...
    def include_weathershift_data(self, mode):
        path2spilit = self.root_path.joinpath('splits').joinpath(mode)
        pass
